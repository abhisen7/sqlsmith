...
This is a public fork of the original upstream, intended for the purpose of integrating Firebolt into SQLsmith, and is
currently undergoing rapid development for Firebolt CI fuzzing.

This fork is currently maintained by Product Security, but contributions from Engineering are heavily encouraged to fine tune
