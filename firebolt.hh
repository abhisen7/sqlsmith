...
struct dut_fb : dut_base, connect_fb, general {
  ...
  static size_t dut_callback(char* ptr, size_t size, size_t resp_size, void* userdata); //callback function to parse HTTP response 
  static size_t header_callback(char* buffer, size_t size, size_t nitems, void* userdata); //callback function to parse HTTP response headers
